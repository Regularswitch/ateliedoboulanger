...
jQuery('document').ready(function ($) {
    ...
    if($('.wrapper').hasClass('home') || $('.wrapper').hasClass('cursos') || $('.wrapper').hasClass('sobre') || $('.wrapper').hasClass('equipe')) {
        ...
        function init() {
            ...
            var mapOptions = {
                ...
                center: new google.maps.LatLng(-23.598055638252198,-46.620147841778014), // New York
            ...
            var infowindow = new google.maps.InfoWindow({content: "France Panificação"});

            // Let's also add a marker while we're at it
            var marker = new google.maps.Marker({
                position: new google.maps.LatLng(-23.598055638252198,-46.619147841778014),
                map: map,
                title: 'France Panificaçao'
            });
