...
<div class="wrapper comprar">
	...
	<div class="comprar__form">
        ...
        <div class="comprar__payment_info blue bold">
            <div class="bold"><?= mb_strtoupper(__('* Informacões de pagamento', 'atelie')) ?></div>
            <div class="content">
                <?= __('50% à vista Transferência bancaria  | 
                        50% À vista Boleto  | 
                        50% 5 dias antes do início do curso  | 
                        50% no cartão de crédito com acréscimo  |   
                        6% de juros no valor total', 'atelie') ?>
            </div>
        </div>
	</div>
